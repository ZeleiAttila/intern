...
public class RandomUser {
    ...
    private static Logger logger = Logger.getLogger(RandomUser.class);
    /**
    ...
    public RandomUser(JSONObject user) {
        ...
        try{
        setZip((Integer) address.get("zip"));
        }catch (Exception e) {
        	setZip(new Integer((String) address.get("zip")));
        	logger.debug(e.getMessage(),e);
		}
        setState((String) address.get("state"));
